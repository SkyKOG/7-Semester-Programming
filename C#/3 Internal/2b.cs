...
For all other data types an exception is thrown. 

In short the IConvertible interface allows the programmer to "convert" an entire object to one of the basic data
types or other types as the requirement may be.
